...
class Tree(object):
    ...
    def entropy(Y):
        ...
        T = p
        e = ((-g/T)  * math.log2(g/T)) - ((b/T) * math.log2(b/T))
    ...
    def conditional_entropy(Y,X):
        ...
        sum = 0    
        for j in range(d):
            c[j]= ((-g[j]/T)  * math.log2(g[j]/T)) - ((b[j]/T) * math.log2(b[j]/T))
            sum += c[j]
        ce = sum/c
        #########################################
        return ce 
    ...
    #--------------------------
    @staticmethod
    def load_dataset(/home/prasanna/Documents/courses/Machine Learning/data1.csv'):
        '''
        ...
        dataset_1 = np.genfromtxt(filename, delimiter = ',', dtype= 'U')
...
filename = "/home/prasanna/Downloads/data1.csv"
X,Y = Tree.load_dataset(filename)
print(X.shape)
print(X[:,1:].shape)
op1 = Tree.entropy(Y)
op2 = Tree.conditional_entropy(Y,X)
print(op1)
print(op2)
